...
def main(args):
    ...
    if args.Vanilla:
        ...
        if args.use_lenet:
            vanilla_lenet_pp = agnostophobia.model.LeNet()
        else:
            vanilla_lenet_pp = agnostophobia.model.LeNet_plus_plus()
        ...
        if args.use_lenet:
            raw_weights = agnostophobia.model.LeNet()
            bg_model = agnostophobia.model.LeNet(background_class=True)
        else:
            raw_weights = agnostophobia.model.LeNet_plus_plus()
            bg_model = agnostophobia.model.LeNet_plus_plus(background_class=True)
        ...
        weights[0] = np.concatenate((weights[0], -0.0001 * np.random.random_sample((weights[0].shape[0], 1)) + 0.0001),
                                    axis=1)
        ...
        if args.use_lenet:
            negative_training_lenet_pp = agnostophobia.model.LeNet()
        else:
            negative_training_lenet_pp = agnostophobia.model.LeNet_plus_plus()
        ...
        # nested funciton so that knownsMinimumMag is in scope
        ...
        if args.use_lenet:
            ...
            model = agnostophobia.model.LeNet_plus_plus()
...
def get_parser():
    ...
    parser.add_argument("--results_dir",
                        help="Directory to store results in. If use_lenet is True sets to LeNet/Models/",
                        action="store",
